...
public class timedTeleport implements Runnable {
    ...
    public timedTeleport(Plugin plugin, Player p, Location l, long ticks) throws IllegalArgumentException {
        if (p == null)
        ...
        task_id = CustomHub.getServer().getScheduler().runTaskTimer(plugin, this, 20, 20).getTaskId();
    }
